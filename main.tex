...
\tikzset{
    hollow/.style={circle, draw, fill=white, inner sep=0pt, minimum size=2mm}
}

\newcommand{\bbeta}{\mbox{\boldmath $\beta$}}
\newcommand{\bD}[1]{\mbox{\boldmath \Delta}}
...
\newcommand{\flst}[3]{#3(#1_1),\ldots,#3(#1_{#2})}
\newcommand{\flstrep}[3]{#3[#1_1],\ldots,#3[#1_{#2}]}
\newcommand{\tflst}[3]{#1_1\otimes #3,\ldots,#1_{#2}\otimes #3}
\newcommand{\tenlst}[3][1]{#2_{#1}\otimes\ldots #2_{#3}}

\newcommand{\op}{{\textup{op}}}
\newcommand{\Hom}{\textup{Hom}}
\newcommand{\dHom}{\textup{\textbf{Hom}}}
\newcommand{\dhom}{\textup{\textbf{hom}}}
\newcommand{\icos}{$\infty$-cosmos}
\newcommand{\Aut}{\textup{Aut}}
\newcommand{\freeOp}[1]{\Omega(#1)}
\newcommand{\drep}[1]{\Omega[#1]}
...
\newcommand{\theCat}{\mathcal{C}\cat{at}}
\newcommand{\MCat}{\mathcal{MC}\cat{at}}
\newcommand{\Nrv}[1]{\textup{N}\boldsymbol{#1}}

\newcommand{\dset}{\cat{d}\mathcal{S}\cat{et}}
\newcommand{\sset}{\cat{s}\mathcal{S}\cat{et}}
\newcommand{\simp}{\boldsymbol{\Delta}}
\newcommand{\dend}{\boldsymbol{\Omega}}

\newcommand{\iof}[2]{#1 \circ_i #2}
\newcommand{\bv}{\otimes_{BV}}
\newcommand{\bnerv}[1]{\textup{N}\boldsymbol{#1}}
...
\begin{center}
\vspace*{.25in}
{\bf\LARGE{ WORKING TITLE }}\\ % change it accordingly, title must be in ALL CAPS!
\vspace*{.75in}
{\bf by} \\*[18pt]
\vspace*{.2in}
{\bf Alvaro Belmonte}\\ % change it accordingly!
\vspace*{1in}
...
\vspace*{.5in}
\begin{small}
{\bf \copyright{ }2026 by Alvaro Belmonte} \\ % change the year if needed!
